...
- **Ziele der Prüfung:** Validiert wird, ob Nutzerinnen und Nutzer schnell eine passende Aktivität finden, Filter verstehen, Detailinformationen korrekt einordnen, eine Aktivität speichern oder planen können und ob Karte, History, Teilen-Prototyp, Community-Ausblick, Profil und Aktivitätserfassung nachvollziehbar sind.
- **Fragestellungen:** Können Testpersonen den Zweck von VibeMatch ohne Erklärung beschreiben? Finden sie eine passende Aktivität für Zürich oder St. Gallen? Sind Preis, Dauer, Ort, Bewertungen und Planungsinfos ausreichend klar? Ist verständlich, dass Community erst für ein späteres MVP vorgesehen ist? Wirkt die Erfassungsseite professionell und bedienbar?
...
- **Vorgehen:** Die Validierung ist als moderierter Test mit lautem Denken vorbereitet. Eine Person stellt Aufgaben und hilft nur bei Blockaden; eine zweite Person beobachtet Klickpfade, Hürden, Zitate, Verbesserungsideen und Screenshots. Das vollständige Testskript liegt in `docs/validate-test-plan.md`.
- **Herleitung der Testaufgaben:** Die Aufgaben sind direkt aus den User-Journey-Workflows aus Kapitel 3.3 abgeleitet. Jede Aufgabe entspricht einem Persona-/Journey-Szenario: Lea/Paar-Flow, Nico/First-Date-Flow, Sara/Gruppen-Flow, Mia/Time-Saver-Flow, Jonas/Creator-Flow sowie Community-Ausblick als MVP-Abgrenzung.
- **Aufgaben/Szenarien:** Einloggen, Home verstehen, passende Aktivität finden, Detailseite bewerten, Wishlist und Planung nutzen, Karte verwenden, History/Review prüfen, Teilen-Prototyp und Community-Ausblick einordnen, neue Aktivität erfassen und optional Mobile Navigation testen. Für die Durchführung gibt es zusätzlich eine kurze Aufgabenkarte, die Testpersonen auf Papier oder einem separaten Gerät sehen können.
...
- **Zusammenfassung der Resultate:** Die aktuelle interne Prüfung führte bereits zu Verbesserungen bei Mobile Navigation, API-Validierung, Empty States, Fokuszuständen, Modal-Escape-Verhalten, Detailseitenlayout, Erfassungsformular und Community-Abgrenzung. Ergebnisse aus den Studierenden-Tests werden nach Durchführung in denselben Beobachtungsbogen eingetragen und hier zusammengefasst.
- **Abgeleitete Verbesserungen:** Für die Abgabe wurden leere Datenzustände robuster gemacht, Community bewusst als MVP-2-Ausblick deklariert, Mobile Navigation erweitert, Profil-/Modal-Feedback verbessert, API-Fehlerantworten vereinheitlicht und eine manuelle Flow-Checkliste in `docs/manual-flow-checklist.md` angelegt. Weitere Anpassungen aus der Testingphase werden als umgesetzt, dokumentiert oder späteres MVP eingeordnet.
