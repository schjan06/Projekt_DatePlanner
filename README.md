...
- **Profil:** Die Profilseite zeigt dynamische Userdaten, Statistik-Karten, Lieblingskategorien und Einstellungseinträge. Die Lieblingskategorien werden als klickbare Chips angezeigt und führen zur passenden Filterseite. Die Aktionen öffnen Modals für Profil bearbeiten, Passwort ändern, Benachrichtigungen, Hilfe & Support, Freunde einladen und Logout.
...
- **Beschreibung & Nutzen:** Die Profilseite ist nicht mehr rein statisch. Userdaten können bearbeitet werden, Passwort und Benachrichtigungen sind verwaltbar, Lieblingskategorien werden sichtbar gemacht, und bisher funktionslose Einstellungspunkte zeigen sinnvolle Modals oder Feedback.
- **Wo umgesetzt:**
...
- **Technische Umsetzung:** Profiländerungen werden über `PUT /api/profile` gespeichert. Passwortänderungen prüfen das alte Passwort und speichern einen neuen Hash. Benachrichtigungseinstellungen werden in MongoDB persistiert. Lieblingskategorien werden im Profilformular als auswählbare Chips aus den vorhandenen Aktivitätskategorien gepflegt und zusätzlich als Top-Kategorien aus Wishlist und History abgeleitet. Die Chips im Profil verlinken auf `/categories?category=...`. Hilfe & Support sowie Freunde einladen sind als Prototyp-Simulation mit Feedback umgesetzt.
...
- **Testhinweis:** Detailseite öffnen, Review-Zusammenfassung prüfen, maximal drei sichtbare Einzelrezensionen und Button für weitere Rezensionen testen, Bewertung schreiben, aktualisierte Verteilung prüfen, Aktivität teilen und Community-Feed prüfen. History-Eintrag teilen und Community-Feed prüfen.
