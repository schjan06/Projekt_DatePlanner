...
| `src/routes/api/history/share/+server.js` | behalten | API bleibt als dokumentierter Share-Endpunkt fuer History und den Teilen-Prototyp bestehen und wurde validiert |
