...
| 4 | History, Teilen und MVP-Abgrenzung | Sie moechten nachvollziehen, was mit vergangenen Aktivitaeten nach der Durchfuehrung passiert, diese in der History pruefen/bewerten/teilen und verstehen, dass echte Reminder nicht Teil des MVP sind. | History, Bewertung, Rueckblicksnotiz, Teilen-Flow, README-/MVP-Abgrenzung | Ist History als vergangene Aktivitaeten verstaendlich? Werden Reminder-Erwartungen vermieden? | Testperson versteht History und kann Reminder als nicht umgesetztes MVP einordnen. | War der Unterschied zwischen History/Rueckblicksnotiz und echten Remindern klar? |
